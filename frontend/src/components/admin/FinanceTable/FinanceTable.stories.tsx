...
const depositData = [
  {
    ...
    date: '2025-03-20',
    isEvidence: true,
    evidence: 'evidence-url-1',
    isReceipt: true,
    receipt: 'receipt-url-1',
  },
  {
    type: '입금',
    category: '후원금',
  ...
  },
  {
    ...
    date: '2025-03-15',
    isEvidence: true,
    evidence: 'evidence-url-3',
    isReceipt: true,
    receipt: 'receipt-url-3',
  },
  {
    type: '입금',
    category: '후원금',
  ...
  },
  {
    ...
    date: '2025-03-05',
    isEvidence: true,
    evidence: 'evidence-url-5',
    isReceipt: true,
    receipt: 'receipt-url-5',
  },
  {
    type: '입금',
    category: '후원금',
  ...
  },
  {
    ...
    date: '2025-02-28',
    isEvidence: true,
    evidence: 'evidence-url-7',
    isReceipt: true,
    receipt: 'receipt-url-7',
  },
  {
    type: '입금',
    category: '후원금',
    ...
    date: '2025-02-25',
    isEvidence: true,
    evidence: 'evidence-url-8',
    isReceipt: true,
    receipt: 'receipt-url-8',
  },
  {
    type: '입금',
    category: '후원금',
  ...
  },
  {
    ...
    date: '2025-02-15',
    isEvidence: true,
    evidence: 'evidence-url-10',
    isReceipt: true,
    receipt: 'receipt-url-10',
  },
  {
    type: '입금',
    category: '후원금',
  ...
  },
  {
    ...
    date: '2025-02-05',
    isEvidence: true,
    evidence: 'evidence-url-12',
    isReceipt: true,
    receipt: 'receipt-url-12',
  },
];
