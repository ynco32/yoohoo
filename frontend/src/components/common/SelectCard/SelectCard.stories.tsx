...
export const DefaultCard: Story = {
  args: {
    ...
    icon: <IconBox name='iconHeart' size={28} />,
    borderType: 'default',
    isSelected: false,
  },
  decorators: [
    ...
    <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
      <div style={{ width: '165px' }}>
        <SelectCard
          ...
          icon={<IconBox name='iconCalendar' size={24} />}
          borderType='gray'
          isSelected={false}
        />
      </div>
      <div style={{ width: '165px' }}>
        <SelectCard
          ...
          title='일시 후원'
          description='한 번만 후원합니다'
          icon={<IconBox name='iconHeart' size={24} />}
          borderType='none'
          isSelected={true}
        />
      </div>
      <div style={{ width: '165px' }}>
        <SelectCard
          ...
          icon={<IconBox name='iconDoghead' size={24} />}
          borderType='none'
          isSelected={true}
        />
      </div>
      <div style={{ width: '165px' }}>
        <SelectCard
          ...
          icon={<IconBox name='iconDog' size={24} />}
          borderType='gray'
          isSelected={false}
        />
      </div>
